var mainsub_vue = new Vue({
    ...
    methods: {
        ...
        loadCateItems() {
            ...
            axios.get("/MainSubCourse/GetAllSubCategory")
                .then((response) => {
        ...
        async addCategory() {
            try {
                ...
                formData.append('MainSubID', this.CateId);
                formData.append('OrderNumber', this.orderNumber);

                await axios.post('/MainSubCourse/AddSub', formData,
                    {
                        headers: {
        ...
        getItemsById(id) {
            axios.get(`/MainSubCourse/GetByIDSub?id=${id}`)
                .then((response) => {
                    this.idSubCate = response.data.id;
                    this.NameSub = response.data.name;
                    this.CateId = response.data.mainSubID;
                    return Promise.resolve();
                });
        },
        resetDataCategory() {
        ...
        async editCategory() {
            try {
                ...
                await axios.post('/MainSubCourse/UpdateSub', formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
        ...
        getItemsByIdDelete(id) {
            axios.get(`/MainSubCourse/GetByIDSub/${id}`)
                .then((response) => {
                    this.idSubCate = response.data.id;
                    if (this.idSubCate != null) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                const formData = new FormData();
                                formData.append('ID', this.idSubCate);
                                axios.post('/MainSubCourse/DeleteSub', formData, {
                                    headers: {
