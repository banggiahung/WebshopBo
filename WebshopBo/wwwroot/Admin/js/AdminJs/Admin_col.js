    ...
    methods: {
        ...
        async addCategory() {
            try {
                ...
                await axios.post('/ConfigCol/AddChuDe', formData,
                    {
                        headers: {
        ...
        getItemsById(id) {
            axios.get(`/ConfigCol/GetByIDChuDe?id=${id}`)
                .then((response) => {
        ...
        async editCategory() {
            try {
                ...
                await axios.post('/ConfigCol/UpdateChuDe', formData,
                    {
                        headers: {
                            'Content-Type': 'multipart/form-data'
                        }
        ...
        getItemsByIdDelete(id) {
            axios.get(`/ConfigCol/GetByIDChuDe/${id}`)
                .then((response) => {
                    this.idCm = response.data.id;
                    if (this.idCm != null) {
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                const formData = new FormData();
                                formData.append('ID', this.idCm);
                                axios.post('/ConfigCol/DeleteChuDe', formData, {
                                    headers: {
