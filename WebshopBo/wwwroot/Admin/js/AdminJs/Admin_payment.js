var payment_app = new Vue({
    ...
    mounted() {
        ...
        axios.get("/PaymentUser/GetAllListDataRecharage")
            .then((response) => {
    ...
    methods: {
        ...
        loadItems() {
            if (this.loadCheck == false) {
                ...
                axios.get("/PaymentUser/GetCourse")
                    .then((response) => {
                        this.dataCourseList = response.data;
                        return Promise.resolve();
                    })
                axios.get("/PaymentUser/Customer")
                    .then((response) => {
        ...
        async addCourse() {
            try {
                ...
                await axios.post('/PaymentUser/CreatePayment', formData,
                    {
                        headers: {
        ...
        async handleTransaction(userNap) {
            ...
            try {
                if (userNap.status) {
                    ...
                    axios.post('/PaymentUser/UpdateRecharage', formData, {
                        headers: {
                    ...
                    axios.post('/PaymentUser/UpdateRecharageSuccess', formData, {
                        headers: {
                            'Content-Type': 'application/x-www-form-urlencoded'
                        }
            ...
            if (this.id != null || this.id != 0) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        axios.post('/PaymentUser/DeletePack', formData, {
                            headers: {
                                'Content-Type': 'application/x-www-form-urlencoded'
                            }
                        }).then(response => {
